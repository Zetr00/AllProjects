...
public class allAddMoney extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_all_add_money);
    ...
    public void setChart(){
        ...
        for (int i = 0; i < history.size(); ++i) {
            if(history.get(i).getOperation().equals("Add")){
        ...
        data.setCenterText1("Пополнения");
